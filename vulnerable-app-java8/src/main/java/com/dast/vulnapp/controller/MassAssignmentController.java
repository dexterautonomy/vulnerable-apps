...
public class MassAssignmentController {
    ...
    public Object register(@RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "registered", "applied", body);
        } catch (Exception e) {
    ...
    public Object updateProfile(@PathVariable int id, @RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "updated", "id", id, "applied", body);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage());
        }
    }
    ...
    public Object createProduct(@RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "created", "applied", body);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage());
        }
    }
    ...
    public Object patchUser(@PathVariable int id, @RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "patched", "sql", sql.toString(), "applied", body);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage());
        }
    }
    ...
    public Object updateSettings(@PathVariable int id, @RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "settings-updated", "sql", sql);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage());
        }
    }
    ...
    public Object importUser(@RequestBody Map<String, Object> body) {
        try {
            ...
            return Compat.map("status", "imported", "applied", body);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage());
        }
    }
    ...
    public Object bulkUpdate(@RequestBody List<Map<String, Object>> items) {
        ...
        try {
            ...
            return Compat.map("status", "bulk-updated", "count", results.size(), "statements", results);
        } catch (Exception e) {
            return Compat.map("error", e.getMessage(), "partial", results);
        }
    }
}
